/*
   tp46.c programa que captura la señal SIGALRM utilizada con la funcion alarm() para enviar
   ...
   Se cambia la forma de hacer loop general, utilizando las funciones sigsetjmp() y siglongjmp(), volviendo
   desde el manipulador de la  señal de alarma al programa principal.
